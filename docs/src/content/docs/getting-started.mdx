...
## 6. Create a Knowledge Base Agent (optional)

You can create agents from templates that have scoped permissions. For example, a **Knowledge Base** agent can only read files in directories you select — it cannot access the shell, the network, or any other files.
