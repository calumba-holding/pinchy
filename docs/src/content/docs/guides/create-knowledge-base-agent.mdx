...
- Indexing is a manual admin action (step 7). It runs in the background and reports progress in the app, but you still have to ask for it — a scheduled sweep is planned for a later phase.
